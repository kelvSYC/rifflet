 ...
 * @param unknown1 8 bytes with zero documented behavior from either primary source;
 *   preserved raw, not validated. Same treatment as `RaceEntry.unknown`.
 * @param unknown2 128 bytes with zero documented behavior from either primary source;
 *   preserved raw, not validated. Same treatment as `RaceEntry.unknown`.
