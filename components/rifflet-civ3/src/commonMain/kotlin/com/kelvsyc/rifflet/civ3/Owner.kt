 ...
 * [CityEntry], [ClnyEntry], [SlocEntry], and [UnitEntry].
 *
 * `ownerType` discriminates what `owner` means (0=None, 1=Barbarian, 2=Civ → a `RACE` section
 * index, 3=Player → a 0-based player index), per existing reverse-engineering documentation of
 * the BIX/BIQ format.
 */
