 ...
 * [Civ3FormatEra.CONQUESTS] files show 7 flavors per group, each with a 7-element [relations]
 * vector forming a personality/relationship affinity matrix (self-affinity highest, others
 * lower) — but the file format declares both the flavor count (see [FlavGroupEntry]) and this
