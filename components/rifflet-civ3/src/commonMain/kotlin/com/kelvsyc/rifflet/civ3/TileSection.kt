 ...
 * per map tile.
 *
 * There are `width × height / 2` entries, matching Civ3's isometric internal map storage (e.g. a
 * 140×140 `WMAP` produces exactly 9800 `TILE` entries, a 100×100 `WMAP` produces exactly 5000).
 */
