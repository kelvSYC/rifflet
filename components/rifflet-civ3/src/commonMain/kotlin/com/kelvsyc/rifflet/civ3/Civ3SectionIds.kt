...
object Civ3SectionIds {
    ...
    val CONT = ChunkId("CONT")
    val FLAV = ChunkId("FLAV")
    val WCHR = ChunkId("WCHR")
    ...
    val PRTO = ChunkId("PRTO")
    val BLDG = ChunkId("BLDG")
    val TERR = ChunkId("TERR")
    val GAME = ChunkId("GAME")
    val TILE = ChunkId("TILE")
}
